            ...
            {hasTabBar ? (
                <nav className="bg-white text-gray-800 border-t fixed bottom-0 px-10 pb-3 pt-3 flex justify-between items-center w-full max-w-lg mx-auto">
                    <Link href="/" className="flex flex-col items-center space-y-2">
                        ...
                        <span className="text-xs text-gray-700 font-semibold">홈</span>
                    </Link>
                    <Link href="/community" className="flex flex-col items-center space-y-2">
                        ...
                        <span className="text-xs text-gray-700 font-semibold">동네생활</span>
                    </Link>
                    <Link href="/chats" className="flex flex-col items-center space-y-2">
                        ...
                        <span className="text-xs text-gray-700 font-semibold">채팅</span>
                    </Link>
                    <Link href="/stream" className="flex flex-col items-center space-y-2">
                        ...
                        <span className="text-xs text-gray-700 font-semibold">스트리밍</span>
                    </Link>
                    <Link href="/profile" className="flex flex-col items-center space-y-2">
                        ...
                        <span className="text-xs text-gray-700 font-semibold">나의 캐럿</span>
                    </Link>
                </nav>
            ) : null}
        </div>
