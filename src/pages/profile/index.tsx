...
const Profile = () => {
    return (
        <Layout title="나의 캐럿" hasTabBar canGoBack>
            <div className="py-10 px-4">
                <Link href="/profile/edit" className="flex items-center space-x-3">
                ...
                <div className="mt-10 flex justify-around">
                    <Link href="/profile/sort" className="flex flex-col items-center">
                ...
                <div className="mt-12">
                    ...
                    <div className="mt-4 text-gray-600 text-sm">
                        <p>
                            ...
                            period so I don&apos;t wanna kill you, I wanna help you. But I can&apos;t give you this case, it don&apos;t belong to me. Besides,
