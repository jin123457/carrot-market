    ...
    return (
        <div className="bg-slate-400 py-20 px-10 flex flex-col space-y-5 min-h-screen">
            <div className="bg-white p-6 rounded-3xl shadow-xl">
                ...
                <button className="flex justify-center mt-5 bg-blue-500 text-white p-3 text-center rounded-xl w-2/4 mx-auto hover:bg-teal-500 hover:text-black active:bg-yellow-500 focus:bg  -red-500">
                    Checkout
                </button>
            </div>
            ...
            <div className="bg-white p-6 rounded-3xl shadow-xl ">
                ...
                <img src="https://i.ibb.co/5963kz8/chair.jpg" className="bg-zinc-400 h-full mb-5 object-cover w-full" />
                <div className="flex flex-col">
                    ...
                    <div className="flex justify-between items-center">
                        ...
                        <button className="bg-blue-500 text-center text-white py-2 px-10 text-xs rounded-lg">Add to cart</button>
                    </div>
                </div>
            </div>
        </div>
